...
extension Valet {
    ...
    public final class SinglePromptSecureEnclaveValet: NSObject {
        ...
        public class func valet(with identifier: Valet.Identifier, accessControl: Valet.SecureEnclaveAccessControl) -> SinglePromptSecureEnclaveValet {
        ...
        public class func sharedGroupValet(with identifier: Valet.SharedGroupIdentifier, accessControl: Valet.SecureEnclaveAccessControl) -> SinglePromptSecureEnclaveValet {
        ...
        private convenience init(identifier: Valet.Identifier, accessControl: Valet.SecureEnclaveAccessControl) {
            self.init(
        ...
        private convenience init(sharedAccess groupIdentifier: Valet.SharedGroupIdentifier, accessControl: Valet.SecureEnclaveAccessControl) {
            self.init(
        ...
        private init(identifier: Valet.Identifier, service: Service, accessControl: Valet.SecureEnclaveAccessControl) {
        ...
        public let identifier: Valet.Identifier
        @objc
        public let accessControl: Valet.SecureEnclaveAccessControl
        ...
        public func canAccessKeychain() -> Bool {
            Valet.SecureEnclave.canAccessKeychain(with: service)
        }
        ...
        public func setObject(_ object: Data, forKey key: String) throws {
            try execute(in: lock) {
                try Valet.SecureEnclave.setObject(object, forKey: key, options: baseKeychainQuery)
            }
        }
        ...
        public func object(forKey key: String, withPrompt userPrompt: String) throws -> Data {
            try execute(in: lock) {
                try Valet.SecureEnclave.object(forKey: key, withPrompt: userPrompt, options: try continuedAuthenticationKeychainQuery())
            }
        }
        ...
        public func containsObject(forKey key: String) throws -> Bool {
            try execute(in: lock) {
                try Valet.SecureEnclave.containsObject(forKey: key, options: baseKeychainQuery)
            }
        }
        ...
        public func setString(_ string: String, forKey key: String) throws {
            try execute(in: lock) {
                try Valet.SecureEnclave.setString(string, forKey: key, options: baseKeychainQuery)
            }
        }
        ...
        public func string(forKey key: String, withPrompt userPrompt: String) throws -> String {
            try execute(in: lock) {
                try Valet.SecureEnclave.string(forKey: key, withPrompt: userPrompt, options: try continuedAuthenticationKeychainQuery())
            }
        }
        ...
        public class func 🚫swift_valet(with identifier: String, accessControl: Valet.SecureEnclaveAccessControl) -> SinglePromptSecureEnclaveValet? {
            guard let identifier = Valet.Identifier(nonEmpty: identifier) else {
                return nil
            }
        ...
        public class func 🚫swift_sharedGroupValet(appIDPrefix: String, nonEmptyIdentifier identifier: String, accessControl: Valet.SecureEnclaveAccessControl) -> SinglePromptSecureEnclaveValet? {
            guard let identifier = Valet.SharedGroupIdentifier(appIDPrefix: appIDPrefix, nonEmptyGroup: identifier) else {
                return nil
            }
        ...
        public class func 🚫swift_sharedGroupValet(groupPrefix: String, nonEmptyIdentifier identifier: String, accessControl: Valet.SecureEnclaveAccessControl) -> SinglePromptSecureEnclaveValet? {
            guard let identifier = Valet.SharedGroupIdentifier(groupPrefix: groupPrefix, nonEmptyGroup: identifier) else {
                return nil
            }
            return sharedGroupValet(with: identifier, accessControl: accessControl)
        }
