...
extension Valet {
    ...
    public final class SecureEnclaveValet: NSObject {
        ...
        public class func valet(with identifier: Valet.Identifier, accessControl: Valet.SecureEnclaveAccessControl) -> SecureEnclaveValet {
        ...
        public class func sharedGroupValet(with identifier: Valet.SharedGroupIdentifier, accessControl: Valet.SecureEnclaveAccessControl) -> SecureEnclaveValet {
        ...
        public func object(forKey key: String, withPrompt userPrompt: String) throws -> Data {
            try execute(in: lock) {
                try Valet.SecureEnclave.object(forKey: key, withPrompt: userPrompt, options: baseKeychainQuery)
            }
        }
        ...
        public func string(forKey key: String, withPrompt userPrompt: String) throws -> String {
            try execute(in: lock) {
                try Valet.SecureEnclave.string(forKey: key, withPrompt: userPrompt, options: baseKeychainQuery)
            }
        }
        ...
        public class func 🚫swift_valet(with identifier: String, accessControl: Valet.SecureEnclaveAccessControl) -> SecureEnclaveValet? {
        ...
        public class func 🚫swift_sharedGroupValet(appIDPrefix: String, nonEmptyIdentifier identifier: String, accessControl: Valet.SecureEnclaveAccessControl) -> SecureEnclaveValet? {
        ...
        public class func 🚫swift_sharedGroupValet(groupPrefix: String, nonEmptyIdentifier identifier: String, accessControl: Valet.SecureEnclaveAccessControl) -> SecureEnclaveValet? {
